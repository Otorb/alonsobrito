      ...
      <Container maxWidth="lg">
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
          <Grid item xs={12} md={7}>
            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography style={{ textAlign: 'justify' }} sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    'Experto en la normativa que abarca esta compleja disciplina jurídica. Un profesional especializado en esta área conoce la ley que regula tanto los contratos de seguros como las normas que rigen a todo el sector: desde la ordenación y supervisión, a la mediación, los planes y fondos de pensiones, y la defensa del asegurado y del partícipe en planes de pensiones.'
                  }
                </Typography>
              </Box>
            </Box>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            <Box sx={{ lineHeight: 0 }}>
              <Image src="/images/home-hero.png" width={300} height={350} alt="Hero img" />
            </Box>
          </Grid>
        </Grid>
