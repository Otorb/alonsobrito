        ...
        <Grid container spacing={3}>
            ...
            <Box sx={{ position: 'relative' }}>
              ...
              >
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <BorderLinearProgress variant="determinate" color="inherit" value={95} order={2} />
                </Box>
                <Box sx={{ mb: 2 }}>
                  <Typography variant="subtitle1" color="text.secondary">
                    Civil
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Auditor Externo</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Proporcionamos un asesoramiento integral en la práctica aseguradora, civil, entre otros, lo que nos
              permite aportar valor a las compañías de seguros que trabajan con nosotros.
            </Typography>
